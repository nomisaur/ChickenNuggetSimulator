...
namespace ChickenNuggetSimulator.Core.Localization;
...
internal class LocalizationManager
{
    ...
    public static List<CultureInfo> GetSupportedCultures()
    {
        ...
        ResourceManager resourceManager = new ResourceManager("ChickenNuggetSimulator.Core.Localization.Resources", assembly);
